...
def page_inicio():
    ...
    r2 = st.columns(4)
    items2 = [
        ("⚖️", "Comparador de estatinas", "Pitavastatina vs. las demás frente a la meta, con estudios que lo respaldan.", "comparador"),
        ("🧬", "Lipidología de precisión", "ApoB, Lp(a), remanentes y farmacogenómica para elegir la estatina.", "precision"),
...
p_comparador = st.Page(evidence.page_comparador, title="Comparador de estatinas", icon="⚖️", url_path="comparador")
p_precision = st.Page(evidence.page_precision, title="Lipidología de precisión", icon="🧬", url_path="precision")
...
st.session_state["_nav"] = {
    ...
    "comparador": p_comparador, "precision": p_precision,
}
...
pg = st.navigation(
    {
        ...
        "Evidencia comparada": [p_comparador, p_precision],
